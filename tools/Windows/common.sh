...
FFMPEG_MXE_BIN_64_GPL_TAR=ffmpeg-2.8.3.tar.xz-windows-x86_64-shared-GPLv2.tar.xz
FFMPEG_MXE_BIN_32_GPL_TAR=ffmpeg-2.8.3.tar.xz-windows-i686-shared-GPLv2.tar.xz
FFMPEG_MXE_BIN_64_LGPL_TAR=ffmpeg-2.8.3.tar.xz-windows-x86_64-shared-LGPL.tar.xz
FFMPEG_MXE_BIN_32_LGPL_TAR=ffmpeg-2.8.3.tar.xz-windows-i686-shared-LGPL.tar.xz
